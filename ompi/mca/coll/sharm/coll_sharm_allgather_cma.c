...
/**
 * @brief shared-memory based algorithm for Allgather using CMA ZeroCopy.
                        ...
                        mca_coll_base_module_t *module)
{
    ...
    OPAL_OUTPUT_VERBOSE((SHARM_LOG_FUNCTION_INFO, mca_coll_sharm_stream,
                         "coll:sharm:%d:allgather_cma: (%d/%d/%s)",
    ...
    OPAL_OUTPUT_VERBOSE(
        (SHARM_LOG_FUNCTION_INFO, mca_coll_sharm_stream,
         "coll:sharm:%d:allgather_cma: (%d/%d/%s), allgather complete",
