...
/**
 * @brief shared-memory based algorithm for Scatterv using CMA ZeroCopy.
                       ...
                       mca_coll_base_module_t *module)
{
    ...
    OPAL_OUTPUT_VERBOSE((SHARM_LOG_FUNCTION_INFO, mca_coll_sharm_stream,
                         "coll:sharm:%d:scatterv_cma: (%d/%d/%s) root %d",
    ...
    OPAL_OUTPUT_VERBOSE(
        (SHARM_LOG_FUNCTION_INFO, mca_coll_sharm_stream,
         "coll:sharm:%d:scatterv_cma: (%d/%d/%s), root %d scatterv complete",
